...
namespace Browser_Reviewer
{
    ...
    public class MyTools
    {
        ...
        const uint FILE_ATTRIBUTE_DIRECTORY = 0x10;
            ...
            public async Task ListFilesAndDirectories(string path, TextBox textBox_logConsole)
            {
                    ...
                    await Task.Run(async () =>
                    {
                        try
                        {
                                ...
                                do
                                {
                                    ...
                                    if (currentFileName != "." && currentFileName != "..")
                                    {
                                        ...
                                        else
                                        {
                                            try
                                            {
                                                ...
                                                if (Path.GetFileName(fullPath) == "History" && IsSQLite3(fullPath, textBox_logConsole))
                                                {
                                                    if (SetBrowserType(fullPath))
                                                    {
                                                        ...
                                                        LogToConsole(textBox_logConsole, $"Processing : {fullPath}");
                                            ...
                                            {
                                                LogToConsole(textBox_logConsole, $"Access denied to the file: {fullPath}");
                                            }
                                            catch (PathTooLongException)
                                            {
                                                LogToConsole(textBox_logConsole, $"Path too long: {fullPath}");
                                            }
                                            catch (Exception ex)
                                            {
                                                LogToConsole(textBox_logConsole, $"Error processing the file {fullPath}: {ex.Message}");
                            ...
                            else
                            {
                                ...
                                {
                                    LogToConsole(textBox_logConsole, "The directory could not be found or there was an error.");
                                }));
                            }
                        }
                        catch (Exception ex)
                        {
                            textBox_logConsole.Invoke((Action)(() =>
                            {
                                LogToConsole(textBox_logConsole, $"Error processing the directory: {ex.Message}");
                            }));
                        }
                    });
                }
                ...
                {
                    LogToConsole(textBox_logConsole, $"General error in the task: {ex.Message}");
                }
            }
        ...
        private void CopyAndProcessToTemp(string directoryPath, TextBox textBox_logConsole)
        {
            try
            {
        ...
        private void PrintFilePermissions(string filePath, TextBox textBox_logConsole)
        {
            try
            {
        ...
        public void ShowQueryOnDataGridView(SfDataGrid dataGrid, string connectionString, string query, Label labelItemCount)
        {
        ...
        //public void CreateResultsTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        ...
        //public void CreateFirefoxTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        //        string createTableQuery = @"CREATE TABLE IF NOT EXISTS firefox_results (
        //                                id INTEGER PRIMARY KEY AUTOINCREMENT,
        //                                Browser TEXT,
        //                                Category TEXT,
        //                                Potential_activity TEXT,
        ...
        //public void CreateChromeDownloadsTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        //        string createTableQuery = @"CREATE TABLE IF NOT EXISTS chrome_downloads (
        //                                    id INTEGER PRIMARY KEY AUTOINCREMENT,
        //                                    Browser TEXT,
        //                                    Download_id INTEGER,
        //                                    Current_path TEXT,
        ...
        //public void CreateFirefoxDownloadsTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        //        string createTableQuery = @"CREATE TABLE IF NOT EXISTS firefox_downloads (
        //                     id INTEGER PRIMARY KEY AUTOINCREMENT,
        //                     Browser TEXT,
        //                     Download_id INTEGER,
        //                     Current_path TEXT,
        ...
        //public void CreateBookmarksFirefoxTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        //        string createTableQuery = @"
        //                CREATE TABLE IF NOT EXISTS bookmarks_Firefox (
        //                id INTEGER PRIMARY KEY AUTOINCREMENT,
        //                Browser TEXT,
        //                Bookmark_id INTEGER,
        //                Type TEXT,
        ...
        //public void CreateBookmarksChromeTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        //        string createTableQuery = @"
        //               CREATE TABLE IF NOT EXISTS bookmarks_Chrome (
        //                id INTEGER PRIMARY KEY AUTOINCREMENT,
        //                Browser TEXT,
        //                Type TEXT,
        //                Title TEXT,
        ...
        //public void CreateAutofillDataTable(string connectionString)
        //{
        //    using (SQLiteConnection connection = new SQLiteConnection(connectionString))
        //    {
        //        connection.Open();
        ...
        //public static void ProcessAndWriteDownloads(string downloadsConnectionString, string resultsConnectionString, string browserType, string filePath)
        ...
        public static void ProcessAndWriteDownloadsFirefox(string historyConnectionString, string chromeViewerConnectionString, string browserType, string filepath)
        {
            if (!string.IsNullOrEmpty(historyConnectionString))
            {
                using (SQLiteConnection historyConnection = new SQLiteConnection(historyConnectionString))
        ...
        public static void ProcessAndWriteBookmarksFirefox(string historyConnectionString, string chromeViewerConnectionString, string browserType, string filepath)
        {
            if (!string.IsNullOrEmpty(historyConnectionString))
            {
                using (SQLiteConnection historyConnection = new SQLiteConnection(historyConnectionString))
        ...
        public static void ProcessAndWriteRecordsChromeLike(string historyConnectionString, string chromeViewerConnectionString, string browserType, string filepath)
        {
            if (!string.IsNullOrEmpty(historyConnectionString))
            {
                using (SQLiteConnection historyConnection = new SQLiteConnection(historyConnectionString))
        ...
        public static void LogToConsole(TextBox textBox_logConsole,  string message)
        {
        ...
        private async Task TraverseDirectoryAsync(string currentDir, List<string> sqliteFiles, TextBox textBox_logConsole)
        {
            try
            {
        ...
        private bool IsSQLite3(string filePath, TextBox textBox_logConsole)
        {
            ...
            {
                LogToConsole(textBox_logConsole, $"Error al leer el archivo {filePath}: {ex.Message}");
                return false;
            }
        }
        ...
        public static void ProcessAndWriteRecordsFirefox(string historyConnectionString, string chromeViewerConnectionString, string browserType, string filepath)
        {
            if (!string.IsNullOrEmpty(historyConnectionString))
            {
                using (SQLiteConnection historyConnection = new SQLiteConnection(historyConnectionString))
        ...
        public void MostrarPorCategoria(Label labelStatus, SfDataGrid sfDataGrid, string connectionString, string tableName, string categoria, string navegador, Label labelItemCount)
        {
            using (SQLiteConnection connection = new SQLiteConnection(connectionString))
            {
                connection.Open();
                ...
                else
                {
                    ...
                    else
                    {
                      ...
                      STRFTIME('%Y-%m-%d %H:%M:%f', Last_visit_time, '{utcOffset} hours') AS Last_visit_time,
                      Visit_count, Transition, Visit_type, Frecency, File, Label, Comment
                      FROM {tableName} WHERE Category = @Category AND Browser = @Browser {Helpers.sqltimecondition}";
                        }
                        else if (tableName == "results")
                        {
                            query = $@"SELECT id, Browser, Category, Potential_activity, Visit_id, Url, Title, 
        ...
        public static void ProcessAndWriteBookmarksChrome(string chromeViewerConnectionString, string browserType, string filePath)
        {
            if (File.Exists(filePath))
            {
                try
        ...
        public static void ProcessAndWriteAutofillChrome(string chromeViewerConnectionString, string browserType, string filePath)
        {
            ...
            {
                MessageBox.Show("Archivo de datos de autocompletar de Chrome no encontrado.", "ChromeViewer", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
        ...
        public static void ProcessAndWriteAutofillFirefox(string chromeViewerConnectionString, string browserType, string filePath)
        {
            ...
            {
                MessageBox.Show($"Archivo {autofillDbPath} de datos de autocompletar de Firefox no encontrado.", "FirefoxViewer", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
