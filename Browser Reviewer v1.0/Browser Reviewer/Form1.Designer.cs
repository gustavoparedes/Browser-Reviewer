namespace Browser_Reviewer
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // 
            progressBarProcessing.Location = new Point(264, 645);
            progressBarProcessing.MarqueeAnimationSpeed = 30;
            progressBarProcessing.Name = "progressBarProcessing";
            progressBarProcessing.Size = new Size(66, 17);
            progressBarProcessing.Style = ProgressBarStyle.Marquee;
            progressBarProcessing.TabIndex = 23;
            progressBarProcessing.Visible = false;
            // 
            // groupBox_TextBox
            // 
            groupBox_TextBox.Controls.Add(Console);
            groupBox_TextBox.Controls.Add(progressBarProcessing);
